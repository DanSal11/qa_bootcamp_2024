...
//        driver.findElement(By.id("allert-trigger")).click();
    ...
    public void hoverTest() {
        ...
        WebElement button = Utils.waitForElement(driver,5,By.cssSelector("#svelte > div.container-fluid > div.main.row > div.sidebar > a:nth-child(3)"));

        Actions actions = new Actions(driver);
        actions.moveToElement(button).build().perform();

        driver.findElement(By.cssSelector("#Dog"));
    }
}
